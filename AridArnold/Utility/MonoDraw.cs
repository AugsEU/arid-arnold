namespace AridArnold
{
	...
	static class MonoDraw
	{
		...
		/// </summary>
		public static void DrawStringCentredShadow(DrawInfo info, SpriteFont font, Vector2 position, Color color, string text, float dropDist = 2.0f, DrawLayer depth = DrawLayer.Bubble)
		{
			...
			drawPosition.X = MathF.Round(drawPosition.X);
			drawPosition.Y = MathF.Round(drawPosition.Y);
			Vector2 shadowPos = drawPosition + new Vector2(dropDist, dropDist);
